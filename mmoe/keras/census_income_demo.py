# coding=utf-8
# Reference:**********************************************
# @Time     : 2020/8/25 4:21 PM
# @Author   : huangyajian
# @File     : census_income_demo.py
# @Software : PyCharm
# @Comment  :
# Reference:**********************************************
...
class ROCCallback(Callback):
    def __init__(self, training_data, validation_data, test_data):
        ...
        self.validation_data_X = validation_data[0]
        self.validation_data_Y = validation_data[1]
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        validation_prediction = self.model.predict(self.validation_data_X)
        test_prediction = self.model.predict(self.test_X)
        for index, output_name in enumerate(self.model.output_names):
            train_roc_auc = roc_auc_score(self.train_Y[index], train_prediction[index])
            validation_roc_auc = roc_auc_score(self.validation_data_Y[index], validation_prediction[index])
...
def main():
    ...
    for index, task_layer in enumerate(mmoe_layers):
        ...
        print("tower_layer: ", tower_layer.shape)
